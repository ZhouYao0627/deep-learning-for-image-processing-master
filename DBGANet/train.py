...
def main(args):
    ...
    image_path = os.path.join(data_root, "data_set", "UCM21", "80_20")
    ...
    model_weight_path2 = "./weights/B.pth"
    ...
    epochs = 100
    best_acc = 0.0
    save_path = './save_weights/xxx.pth'
    ...
    for epoch in range(epochs):
        ...
        # with open('./Draw/train_accurate_UCM21_8020_Merge_new2.txt', 'a+') as f:
        #     f.write(str(train_accurate) + ',')
        #
        # with open('./Draw/val_accurate_UCM21_8020_Merge_new2.txt', 'a+') as f:
        #     f.write(str(val_accurate) + ',')
        #
        # train_loss1 = running_loss / train_steps
        # with open('./Draw/train_loss_UCM21_8020_Merge_new2.txt', 'a+') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./weights/A.pth',
