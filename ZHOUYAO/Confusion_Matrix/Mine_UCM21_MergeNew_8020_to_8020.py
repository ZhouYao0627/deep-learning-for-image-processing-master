...
class ConfusionMatrix(object):
    ...
    def plot(self):
        ...
        with open('./plot/UCM21_MergeNew_8020_to_8020_matrix1.txt', 'a+') as f:
            f.write(str(matrix))
...
if __name__ == '__main__':
    ...
    model_weight_path = "../Test8_densenet/save_weights/D_R_UCM21_8020_Merge_new1.pth"
