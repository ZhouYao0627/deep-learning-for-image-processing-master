...
#         # plt.savefig('D_R_AID30_8020_Merge_new_CM.jpg')
#
#         # 在图中标注数量/概率信息
...
class ConfusionMatrix(object):
    ...
    def plot(self):
        ...
        plt.tight_layout()  # 图形显示更加紧凑 #保证图不重叠
        plt.savefig("./plot/D_R_AID30_8020_Merge_new_CM15.svg", dpi=300, format="svg")
        plt.show()  # 展示混淆矩阵
...
if __name__ == '__main__':
    ...
    model_weight_path = "../Test8_densenet/save_weights/D_R_AID30_8020_Merge_new_CM.pth"
