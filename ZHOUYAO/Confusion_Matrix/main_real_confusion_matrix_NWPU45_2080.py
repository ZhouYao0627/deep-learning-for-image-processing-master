...
class EF(nn.Module):
    ...
    def __init__(self, net1, net2):
        ...
        self.fc = nn.Sequential(nn.Linear(4256, 45))
...
class ConfusionMatrix(object):
    ...
    def plot(self):  # 绘制混淆矩阵
        ...
        plt.savefig('D_R_cat_twocsam_drop05_2_NWPU45_2080_1.jpg')
...
if __name__ == '__main__':
    ...
    model_weight_path = "../Test8_densenet/D_R_cat_twocsam_drop05_2_NWPU45_1.pth"
