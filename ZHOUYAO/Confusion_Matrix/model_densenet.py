...
def load_state_dict1(model: nn.Module, weights_path: str) -> None:
    ...
    print("successfully load pretrain-weights1.")

def load_state_dict2(model: nn.Module, weights_path: str) -> None:
    # '.'s are no longer allowed in module names, but previous _DenseLayer
    # has keys 'norm.1', 'relu.1', 'conv.1', 'norm.2', 'relu.2', 'conv.2'.
    # They are also in the checkpoints in model_urls. This pattern is used
    # to find such keys.
    ...
    print("successfully load pretrain-weights2.")