...
def main(args):
    ...
    epochs = 100
    best_acc = 0.0
    save_path = './save_weights/D_R_AID30_8020_Merge_SA1.pth'
    ...
    for epoch in range(epochs):
        ...
        with open('./Draw/train_accurate_AID30_8020_Merge_SA1.txt', 'a+') as f:
            f.write(str(train_accurate) + ',')

        with open('./Draw/val_accurate_AID30_8020_Merge_SA1.txt', 'a+') as f:
            f.write(str(val_accurate) + ',')

        train_loss1 = running_loss / train_steps
        with open('./Draw/train_loss_AID30_8020_Merge_SA1.txt', 'a+') as f:
