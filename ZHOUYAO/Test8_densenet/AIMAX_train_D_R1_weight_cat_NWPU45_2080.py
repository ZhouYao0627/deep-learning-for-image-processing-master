...
def main(args):
    ...
    epochs = 100
    best_acc = 0.0
    save_path = './D_R_cat_twocsam_drop05_2_NWPU45_2080_c1024.pth'
    ...
    for epoch in range(epochs):
        ...
        with open('./Draw/train_accurate_D_R_cat_twocsam_NWPU45_2080_c1024.txt', 'a+') as f:
            f.write(str(train_accurate) + ',')

        with open('./Draw/val_accurate_D_R_cat_twocsam_NWPU45_2080_c1024.txt', 'a+') as f:
            f.write(str(val_accurate) + ',')

        train_loss1 = running_loss / train_steps
        with open('./Draw/train_loss_D_R_cat_twocsam_NWPU45_2080_c1024.txt', 'a+') as f:
