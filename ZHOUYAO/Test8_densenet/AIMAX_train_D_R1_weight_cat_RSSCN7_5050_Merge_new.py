...
# UCM21_80_20_0dropout: best_acc: 0.9738095238095238
# UCM21_80_20_1dropout: best_acc: 0.969047619047619
# UCM21_80_20_2dropout: best_acc: 0.9761904761904762
# UCM21_90_10_0dropout: best_acc: 0.9904761904761905
...
def main(args):
    ...
    epochs = 100
    best_acc = 0.0
    save_path = './save_weights/D_R_UCM21_5050_Merge_new.pth'
    ...
    for epoch in range(epochs):
        ...
        with open('./Draw/train_accurate_RSSCN7_5050_Merge_new_0dropout.txt', 'a+') as f:
            f.write(str(train_accurate) + ',')

        with open('./Draw/val_accurate_RSSCN7_5050_Merge_new_0dropout.txt', 'a+') as f:
            f.write(str(val_accurate) + ',')

        train_loss1 = running_loss / train_steps
        with open('./Draw/train_loss_RSSCN7_5050_Merge_new_0dropout.txt', 'a+') as f:
