...
# RSSCN7_80_20_2dropout: best_acc: 0.9375
...
def main(args):
    ...
    image_path = os.path.join(data_root, "data_set", "RSSCN7", "80_20")  # flower data set path
    ...
    epochs = 100
    best_acc = 0.0
    save_path = './save_weights/D_R_UCM21_8020_Merge_new.pth'
    ...
    for epoch in range(epochs):
        ...
        with open('./Draw/train_accurate_RSSCN7_8020_Merge_new_2dropout.txt', 'a+') as f:
            f.write(str(train_accurate) + ',')

        with open('./Draw/val_accurate_RSSCN7_8020_Merge_new_2dropout.txt', 'a+') as f:
            f.write(str(val_accurate) + ',')

        train_loss1 = running_loss / train_steps
        with open('./Draw/train_loss_RSSCN7_8020_Merge_new_2dropout.txt', 'a+') as f:
