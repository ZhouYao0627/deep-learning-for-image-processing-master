...
class EF(nn.Module):
    ...
    def __init__(self, net1, net2):
        ...
        # 修改通道数
        self.conv_1x1_1 = nn.Conv2d(in_channels=4256, out_channels=512, kernel_size=1, padding=0, bias=False)
...
def main(args):
    ...
    epochs = 100
    best_acc = 0.0
    save_path = './save_weights/D_R_cat_twocsam_drop05_2_RSSCN7_Merge_2.pth'
    ...
    for epoch in range(epochs):
        ...
        with open('./Draw/train_accurate_D_R_cat_twocsam_RSSCN7_Merge_4.txt', 'a+') as f:
            f.write(str(train_accurate) + ',')

        with open('./Draw/val_accurate_D_R_cat_twocsam_RSSCN7_Merge_4.txt', 'a+') as f:
            f.write(str(val_accurate) + ',')

        train_loss1 = running_loss / train_steps
        with open('./Draw/train_loss_D_R_cat_twocsam_RSSCN7_Merge_4.txt', 'a+') as f:
