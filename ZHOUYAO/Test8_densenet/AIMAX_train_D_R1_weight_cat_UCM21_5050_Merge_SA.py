...
from CSAM_before_than_cat2_new import csam as csam2
...
class EF(nn.Module):
    ...
    def __init__(self, net1, net2):
        ...
        # 3x3卷积
        self.conv_3x3_1 = nn.Conv2d(in_channels=3072, out_channels=1024, kernel_size=3, stride=1, padding=1, bias=False)
...
def main(args):
    ...
    image_path = os.path.join(data_root, "data_set", "UCM21", "50_50")  # flower data set path
    ...
    net1 = resnext50_32x4d(include_top=False)
    net2 = densenet121()
    ...
    epochs = 100
    best_acc = 0.0
    save_path = './save_weights/D_R_UCM21_5050_Merge_SA_test2.pth'
    ...
    for epoch in range(epochs):
        ...
        with open('./Draw/train_accurate_UCM21_5050_Merge_SA_test3.txt', 'a+') as f:
            f.write(str(train_accurate) + ',')

        with open('./Draw/val_accurate_UCM21_5050_Merge_SA_test3.txt', 'a+') as f:
            f.write(str(val_accurate) + ',')

        train_loss1 = running_loss / train_steps
        with open('./Draw/train_loss_UCM21_5050_Merge_SA_test3.txt', 'a+') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./weights/resnext50_32x4d-7cdf4587.pth',
