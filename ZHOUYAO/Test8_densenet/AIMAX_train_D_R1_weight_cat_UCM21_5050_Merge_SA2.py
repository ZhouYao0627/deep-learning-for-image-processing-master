...
#         self.fc = nn.Sequential(nn.Linear(512, 21))
#
...
#     epochs = 100
#     best_acc = 0.0
#     save_path = './save_weights/D_R_UCM21_5050_Merge_SA_test3.pth'
...
#         with open('./Draw/train_loss_UCM21_5050_Merge_SA_test3.txt.txt', 'a+') as f:
...
def main(args):
    ...
    for epoch in range(epochs):
        ...
        with open('./Draw/train_accurate_UCM21_5050_Merge_SA_test4.txt', 'a+') as f:
            f.write(str(train_accurate) + ',')

        with open('./Draw/val_accurate_UCM21_5050_Merge_SA_test4.txt', 'a+') as f:
            f.write(str(val_accurate) + ',')

        train_loss1 = running_loss / train_steps
        with open('./Draw/train_loss_UCM21_5050_Merge_SA_test4.txt', 'a+') as f:
            f.write(str(train_loss1) + ',')
