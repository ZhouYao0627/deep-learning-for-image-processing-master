...
def main(args):
    ...
    for epoch in range(epochs):
        ...
        with open('./Draw/val_accurate_D_R5_cat.txt', 'a+') as f:
            f.write(str(val_accurate) + ',')

        train_loss1 = running_loss / train_steps
        with open('./Draw/train_loss_D_R5_cat.txt', 'a+') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./resnext101_32x8d-8ba56ff5.pth',
