...
def main(args):
    ...
    epochs = 100
    best_acc = 0.0
    save_path = './D_R_weight_cat_threecbam.pth'
    ...
    for epoch in range(epochs):
        ...
        with open('./Draw/val_accurate_D_R_weight_threecbam.txt', 'a+') as f:
            f.write(str(val_accurate) + ',')

        train_loss1 = running_loss / train_steps
        with open('./Draw/train_loss_D_R_weight_threecbam.txt', 'a+') as f:
