...
class spatial_attention(nn.Module):
    ...
    def __init__(self, kernel_size=7):
        ...
        self.conv1 = nn.Conv2d(in_channels=8512, out_channels=1, kernel_size=kernel_size, padding=padding, bias=False)
        ...
        self.logit = nn.Sequential(
            OrderedDict((
                ('conv', nn.Conv2d(4256, 4256, 3, padding=1, bias=False)),
                ('bn', nn.InstanceNorm2d(4256, affine=True)),
                ('gate', SoftGate()),
            ))
        )
