...
def main():
    ...
    epochs = 100
    best_acc = 0.0
    save_path = './save_weights/train_NWPU45_8020.pth'
    ...
    for epoch in range(epochs):
        ...
        with open('./Draw/train_accurate_NWPU45_8020.txt', 'a+') as f:
            f.write(str(train_accurate) + ',')

        with open('./Draw/val_accurate_NWPU45_8020.txt', 'a+') as f:
            f.write(str(val_accurate) + ',')

        train_loss1 = running_loss / train_steps
        with open('./Draw/train_loss_NWPU45_8020.txt', 'a+') as f:
