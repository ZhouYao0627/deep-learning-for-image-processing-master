...
# best_acc: 0.9606349206349206 -> 96.06
def main():
    ...
    image_path = os.path.join(data_root, "data_set", "NWPU45", "90_10")  # flower data set path
    ...
    net.fc = nn.Linear(in_channel, 45)
    net.to(device)
    ...
    epochs = 100
    best_acc = 0.0
    save_path = './save_weights/train_NWPU45_9010.pth'
    ...
    for epoch in range(epochs):
        ...
        with open('./Draw/train_accurate_NWPU45_9010.txt', 'a+') as f:
            f.write(str(train_accurate) + ',')

        with open('./Draw/val_accurate_NWPU45_9010.txt', 'a+') as f:
            f.write(str(val_accurate) + ',')

        train_loss1 = running_loss / train_steps
        with open('./Draw/train_loss_NWPU45_9010.txt', 'a+') as f:
