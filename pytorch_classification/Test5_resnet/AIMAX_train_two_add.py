...
class EF(nn.Module):
    ...
    def __init__(self, net1, net2):
        ...
        self.fc = nn.Sequential(nn.Linear(512 * 4, 5))
...
def main():
    ...
    net1 = resnet50(num_classes=5, include_top=False)
    net2 = resnext101_32x8d(num_classes=5, include_top=False)
    # 使用了迁移学习 59-70
    ...
    epochs = 100  # 原来是3
    best_acc = 0.0
    save_path = './AIMAX_train_two_add.pth'
