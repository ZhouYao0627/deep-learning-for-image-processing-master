...
class Inception(nn.Module):
    def __init__(self, in_channels, ch):
        ...
        self.branch1 = BasicConv2d(in_channels, ch, kernel_size=1, padding=1)
        self.branch2 = BasicConv2d(in_channels, ch, kernel_size=1, padding=1)
...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=19, alpha=1.0, round_nearest=8):
        ...
        # features.append(ConvBNReLU(160, 320, stride=2)) # 若把inverted_residual_setting最后一行注释的话需把这行取消注释
        block1 = Inception
        features.append(block1(320, 1024))
