...
from pytorch_classification.grad_cam.swin_model import swin_base_patch4_window7_224_in22k
...
def main():
    ...
    img_path = os.path.join(data_root, "train", "overpass", "overpass_019.jpg")
    # img_path = os.path.join(data_root, "B", "overpass", "0002.tif")
    # img_path = "both.png"
    ...
    target_category = 8948  # tabby, tabby cat
